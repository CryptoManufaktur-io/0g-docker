...
is_public_ipv4() {
  ...
  if (( 10#${o1} == 192 && 10#${o2} == 0 && 10#${o3} == 2 )); then
    return 1
  fi
  if (( 10#${o1} == 192 && 10#${o2} == 31 && 10#${o3} == 196 )); then
    return 1
  fi
  if (( 10#${o1} == 192 && 10#${o2} == 52 && 10#${o3} == 193 )); then
    return 1
  fi
  if (( 10#${o1} == 192 && 10#${o2} == 88 && 10#${o3} == 99 )); then
    return 1
  fi
  if (( 10#${o1} == 192 && 10#${o2} == 175 && 10#${o3} == 48 )); then
    return 1
  fi
  if (( 10#${o1} == 198 && 10#${o2} == 51 && 10#${o3} == 100 )); then
    return 1
  fi
  if (( 10#${o1} == 203 && 10#${o2} == 0 && 10#${o3} == 113 )); then
    return 1
  fi
